...
public class PayBill extends JFrame implements ActionListener{
    ...
    PayBill(String meter){
        ...
        //meternumber and name will come from customer table and other three will come from bill table
        try{
          Conn c=new Conn();
        ...
        //with the change of month bill should show fetails of that month
